...
def lxmlFindAll2(*args,**kwargs):
    kwargs['Data'] = kwargs['Data'].get_element_by_id('all_per_game')
    return kwargs
 
@on_start
def lxmlFindAll3(*args,**kwargs):
    kwargs['Data'] = kwargs['Data'].findall('.//table')[0]
    return kwargs
 
@on_start
def lxmlTable2Pandas4(*args,**kwargs):
...
class StremeNode:
    ...
    def run(self,*args,**kwargs):
        self.kwargs=stop(**pandaExcelDump(**lxmlTable2Pandas4(**lxmlFindAll3(**lxmlFindAll2(**lxmlParseUrl1(**kwargs))))))
        return (self.kwargs)
...
class liveprocess:
    ...
    def run(self,expname):
        self.response=stop(**pandaExcelDump(**lxmlTable2Pandas4(**lxmlFindAll3(**lxmlFindAll2(**lxmlParseUrl1(**start()))))))
